...
import static ua.sumdu.java.lab2.instant_messenger.entities.CategoryUsers.*;
...
public class RequestGeneratingImplTest {
    ...
    public void addToFriends() {
        ...
        assertEquals("uncorrected result: <" + result + ">, but should be <" + correctRequest + ">", correctRequest, result);
    }
